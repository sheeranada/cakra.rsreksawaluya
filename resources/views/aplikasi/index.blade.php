...
@section('content')
    ...
    <div class="wrapper">
        <!-- Navbar -->
        <x-navbar.navbar>
            <x-form.form action="/aplikasi/simpan" method="post">
                <div class="row">
                    <div class="col">
                        <x-inputan.inputan idfor="nama_aplikasi" name="nama_aplikasi" label="NAMA APLIKASI" value="" />
                        <x-inputan.inputan idfor="url" name="url" label="URL" value="" />
    ...
    <x-sidebar.sidebar>
        ...
        <x-li.li link="/aplikasi" onclick="active" label="Aplikasi" icon=" fas fa-robot" />
        ...
        <div class="content-wrapper">
            ...
            <x-header.header judul="Data Aplikasi" url="aplikasi" />
            ...
            <section class="content">
                ...
                <x-card.card judul="List Aplikasi">
                    <x-table.table :headers="['NAMA APLIKASI', 'URL', 'USER LOGIN', 'PASSWORD', 'TERAKHIR UPDATE','PILIHAN']">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                        <x-modal.modal target="edit-{{ Crypt::encrypt($app->id) }}" judul="Edit Data Aplikasi" btn="EDIT"
                                            btnclass="warning">
                                            <x-form.form action="/aplikasi/update/{{ $app->id }}" method="post">
                                                @method('put')
                                                <div class="row">
                                                    <div class="col">
                                                        <x-inputan.inputan idfor="nama_aplikasi" name="nama_aplikasi"
                                                            label="NAMA APLIKASI" value="{{ $app->nama_aplikasi }}" />
                                                        <x-inputan.inputan idfor="url" name="url" label="URL"
                                                            value="{{ $app->url }}" />
                                                        <x-inputan.inputan idfor="user_login" name="user_login"
                                                            label="USER LOGIN" value="{{ $app->user_login }}" />
                                        ...
                                        <x-button.button href="/aplikasi/hapus/{{ Crypt::encrypt($app->id) }}"
